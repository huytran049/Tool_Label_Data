...
namespace QcGate.Libs
{
    public class ManageLog
    {
        private static string LogFile = "QcGateLog.txt";
        //MB
        ...
        public static void WriteLog(string logContent)
        {
            ...
            var strLogDir = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
            if (strLogDir == null)
            {
                return;
            }
            if (!strLogDir.EndsWith("\\"))
                strLogDir += "\\";
            LogFile = "QcGateLog_"+DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() +"_"+ DateTime.Now.Day.ToString() + ".txt";
